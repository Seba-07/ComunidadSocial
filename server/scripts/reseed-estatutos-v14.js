...
const ARTICULOS_V14 = [
  ...
  { numero: 6, titulo: 'Directorio (Composición)', contenido: 'La dirección y administración de la organización corresponde a un Directorio compuesto por {{N_MIEMBROS}} miembros titulares, elegidos en votación directa y secreta por la Asamblea General.\n\nLos directores durarán {{DURACION_MANDATO}} en sus cargos y podrán ser reelegidos hasta por dos períodos consecutivos, conforme a la Ley N° 19.418. En caso de vacancia, el cargo será provisto por el Directorio, eligiendo entre los socios, por el tiempo que falte para completar el período.', esEditable: true, orden: 6 },
...
const PLACEHOLDERS_V14 = [
  ...
  { key: '{{MES_INFORME}}', label: 'Mes de balance anual (Comisión Revisora)', tipo: 'month', required: false, defaultValue: 'Marzo' },
